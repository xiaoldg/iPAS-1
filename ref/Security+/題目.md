### 第一章  Risk management and incident response
```
...
```
### 第二章  Network security technologies
```
...
D. A firewall
```
### 第三章  Secure network design and management
```
...
D. 802.1x
```
### 第四章  Operational and environmental security
```
...
D. Pharming
```
### 第六章  Monitoring, detection, and defense
```
...
D. Multifactor
```
### 第七章  Vulnerability assessment and management
```
...
D. A ping sweep
```
### 第八章 The importance of application security
```
...
```
### 第九章  Establishing host security
```
...
D. A screen lock
```
### 第十章  Understanding data security
```
...
```
### 第十一章  Identity and access control
```
